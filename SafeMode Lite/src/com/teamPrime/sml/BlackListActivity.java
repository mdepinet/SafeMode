...
//	Map<Long, Triple<String,Integer,String>[]> iDmapFull = new TreeMap<Long, Triple <String,Integer,String>[]>();
	...
	private static final int maxContacts = 1;
        ...
        if (readOnly){
	        ...
	        mAddButton.setOnClickListener(new OnClickListener(){    	 	
	        	public void onClick(View v){
	        		...
	        		else if (addedContacts.size() >= maxContacts)
	        			Toast.makeText(getApplicationContext(), "You may only have "+maxContacts+" contact in lite mode", Toast.LENGTH_SHORT).show();
	        		else{
...
//	        			}
	        ...
	        mAddAll.setOnClickListener(new OnClickListener(){    	 	
	        	public void onClick(View v){	
        			Toast.makeText(getApplicationContext(), "This feature is unavailable in Lite mode", Toast.LENGTH_SHORT).show();
	        	}
	        	});
